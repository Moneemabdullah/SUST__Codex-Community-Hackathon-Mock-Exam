...
import { buildHealthRouter } from './routes/v1/health.routes.js';
import { buildVersionRouter } from './routes/v1/version.routes.js';
import { buildMetricsRouter } from './routes/v1/metrics.routes.js';
